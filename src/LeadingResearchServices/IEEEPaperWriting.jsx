    ...
    <section className="ieee-paper">
      ...
      <div className="page-layout">
        ...
        <aside className="left-sidebar2">
          <h3>Quick Links</h3>
          <ul>
            <li><a href="/phd-proposal-writing">PhD Proposal</a></li>
            <li><a href="/journal-paper-writing">Journal Paper Writing</a></li>
            <li><a href="/scopus-paper-support">Scopus / SCI Support</a></li>
            <li><a href="/proposal-step-guide">Proposal Step Guide</a></li>
            <li><a href="/research-funding-guide">Funding Guide</a></li>
          </ul>
        </aside>
...
[8] Submission + PPT Slides for Conference
        ...
        {/* RIGHT SIDEBAR */}
        <aside className="right-tags">
          <h3>Popular Keywords</h3>
          <ul>
            <li>IEEE Conference Papers</li>
            <li>Technical Paper Writing</li>
            <li>IEEE Xplore Publications</li>
            <li>Engineering Research Papers</li>
