...
const faqs = [
  {
    ...
    answer:
      "Narpavi Research Institute’s IoT Project Development Center supports B.Tech, M.Tech, and Ph.D. students in developing IEEE-aligned (2023–2025) projects in IoT, focusing on smart cities, healthcare, industrial automation, and AI-driven IoT solutions for scalable, secure, and efficient systems."
  },
  {
    question: "What types of IoT projects are supported?",
    answer:
      "We support B.Tech projects (IoT sensor networks, smart home systems), M.Tech projects (edge computing, LoRaWAN systems), and Ph.D. projects (federated learning, blockchain-integrated IoT) for applications in smart grids, agriculture, and healthcare."
  },
  {
    question: "Which technologies are used in IoT project development?",
    answer:
      "Our stack includes MQTT, CoAP, LoRaWAN, 5G IoT, TensorFlow Lite, AWS IoT, and microcontrollers like ESP32 and Raspberry Pi for advanced IoT solutions."
  },
  {
    question: "How are projects aligned with IEEE standards?",
    answer:
      "Projects are based on IEEE Transactions (2023–2025), covering areas like AI-driven IoT, secure IoT architectures, and edge computing, ensuring academic and industry relevance."
  },
  {
...
const ECEIoTProjectDevelopmentCenter = () => {
  return (
    <div className="ECEProjectDevelopmentCenter">
      ...
      {/* ✅ SEO FIXED */}
      <SEO
        title="Internet of Things (IoT) – Project Development Center in Chennai"
        ...
        url="/iot-project-development-center-chennai"
        keywords={keywords}
        faqs={faqs}
      />
      ...
      <div className="ECEProjectDevelopmentCenter-main">
        ...
        <Leftsidebar/>
          ...
          <div className="ECEProjectDevelopmentCenter-center">
            <h1>Internet of Things (IoT) – Project Development Center in Chennai</h1>
