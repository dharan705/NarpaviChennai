...
const faqs = [
  {
    ...
    answer:
      "Narpavi Research Institute’s IoT-based Precision Agriculture Project Development Center supports B.Tech, M.Tech, and Ph.D. students in developing IEEE-aligned (2023–2025) projects in smart farming, crop monitoring, irrigation optimization, and predictive analytics using IoT sensors, drones, edge computing, and AI/ML."
  },
  {
    question: "What types of IoT-based Precision Agriculture projects are supported?",
    answer:
      "We support B.Tech projects (sensor-based crop monitoring), M.Tech projects (drone imaging, predictive analytics), and Ph.D. projects (AI-enhanced farm optimization, autonomous drones)."
  },
  {
    question: "Which technologies are used in IoT-based Precision Agriculture project development?",
    answer:
      "Our stack includes Arduino, ESP32, MQTT/CoAP, AWS IoT, Azure IoT, Python (TensorFlow, PyTorch), drones, edge computing platforms, and dashboards."
  },
  {
    question: "How are projects aligned with IEEE standards?",
    answer:
      "Projects are based on IEEE Transactions and Conferences (2023–2025), covering AI-driven irrigation, drone-based crop monitoring, and edge-enabled analytics."
  },
  {
    question: "What support is provided for academic submissions?",
    answer:
      "We offer end-to-end guidance including topic selection, sensor-drone integration, AI/cloud implementation, documentation, and IEEE/Scopus/SCI publication support."
  }
];

/* ================= KEYWORDS ARRAY ================= */
const keywords = [
  "IoT Precision Agriculture Projects",
  "Smart Farming IoT 2023–2025",
  "AI in Agriculture",
  "Drone-Based Crop Monitoring",
  "Edge IoT for Agriculture",
  "Cloud-Integrated Smart Farm",
  "Predictive Farming Analytics",
  "IEEE Agriculture IoT Projects",
  "Narpavi Research Institute Smart Farming",
  "IoT Crop Monitoring System",
  "Precision Agriculture Sensors",
  "IoT-Based Farm Optimization"
];
...
const ECEIoTPrecisionAgricultureProjectDevelopmentCenter = () => {
  return (
    <div className="ECEProjectDevelopmentCenter">
      ...
      {/* ================= SEO ================= */}
      <SEO
        title="IoT-based Precision Agriculture – Project Development Center in Chennai"
        description="IEEE-aligned (2023–2025) IoT-based precision agriculture projects on smart irrigation, drone-enabled crop monitoring, soil and climate sensing, edge analytics, and AI/ML-based yield and pest prediction."
        keywords={keywords}
        url="/department/iot-projects/iot-precision-agriculture-project-development-center-in-chennai"
        faqs={faqs}
      />
      ...
      <div className="ECEProjectDevelopmentCenter-main">
        <div className="ECEProjectDevelopmentCenter-grid">
          ...
          <div className="ECEProjectDevelopmentCenter-center">
            <h1>IoT-based Precision Agriculture – Project Development Center in Chennai</h1>
