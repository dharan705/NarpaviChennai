...
const faqs = [
  {
    ...
    answer:
      "PhD admissions are typically announced once a year in June–July. Check the official Calicut University portal for updates.",
  },
  {
    question: "What is the eligibility criteria?",
    answer:
      "A Master's degree with at least 55% marks (50% for reserved categories). Valid NET/JRF/GATE scores may exempt entrance.",
  },
  {
    question: "Is there an entrance exam and interview process?",
    answer:
      "Yes. The university conducts its own written test followed by an interview unless exempted by NET/GATE/JRF.",
  },
  {
    question: "Are part-time PhD positions available?",
    answer:
      "Yes. Part-time PhD is open to professionals with a minimum of 2 years of work experience and NOC.",
  },
  {
    question: "Does University of Calicut offer fellowships?",
    answer:
      "Yes, UGC-JRF, KSCSTE, and university assistantships are available based on merit.",
  },
];
...
const universityData = {
  ...
  scholarshipAvailability:
    "UGC-JRF, KSCSTE & University assistantships",
};

const UnivCalicut = () => (
  <div className="kerala-main">
    <SEO
      title="PhD Admission at University of Calicut, Malappuram"
      description="PhD admission guidance for University of Calicut – eligibility, university entrance/NET/GATE/JRF options, full-time and part-time PhD, timelines, fees, documents, and fellowship details."
      url="/kerala/phd-admission-at-university-of-calicut"
      keywords={[
        "PhD admission University of Calicut",
        "Calicut University PhD eligibility",
        "Calicut University PhD entrance test",
        "part-time PhD Calicut University",
        "University of Calicut PhD fellowships",
      ]}
      faqs={faqs}
    />
      ...
      <div className="kerala-content-layout">
        ...
        <div className="kerala-side-box kerala-left-box">
          ...
          <ul>
            ...
            <li>
              <b>Why Choose CU:</b>
              <br /> Largest university in Kerala with robust campus and
              research facilities.
            </li>
          </ul>
        </div>
