...
const faqs = [
  {
    ...
    answer:
      "CVV typically opens PhD admissions once per academic year. Notifications are announced in June–July on the official website.",
  },
  {
    question: "What is the eligibility criteria?",
    answer:
      "A master’s degree with a minimum of 55% marks (50% for reserved categories). NET/JRF/GATE/UGC-NET are accepted for exemption.",
  },
  {
    question: "Is there an entrance exam and interview?",
    answer:
      "Yes. CVV conducts its own entrance test followed by an interview. NET/JRF/GATE qualified candidates may be exempted from the written exam.",
  },
  {
    question: "Are part-time PhD options available?",
    answer:
      "Yes, working professionals with relevant experience and a No Objection Certificate can apply for a part-time PhD.",
  },
  {
    question: "Does CVV offer fellowships?",
    answer:
      "Yes. CVV provides scholarships and research assistantships based on merit and department approvals.",
  },
];

const universityData = {
  fullName:
    "PhD Admission at Chinmaya Vishwa Vidyapeeth (CVV), Ernakulam",
  shortName: "CVV",
  ...
  applicationTimeline:
    "June–July each year (Check CVV admission portal)",
  approxFee: "₹25,000 – ₹45,000 per year",
  scholarshipAvailability:
    "Available based on merit; department-funded assistantships",
};

const ChinmayaVishwaVidypeeth = () => (
  <div className="kerala-main">
    <SEO
      title="PhD Admission at Chinmaya Vishwa Vidyapeeth (CVV), Ernakulam"
      description="PhD admission guidance for Chinmaya Vishwa Vidyapeeth, Ernakulam – eligibility, CVV entrance / NET/JRF/GATE exemptions, full-time and part-time modes, fees, documents, and fellowship options."
      url="/kerala/phd-admission-at-chinmaya-vishwa-vidyapeeth"
      keywords={[
        "PhD admission Chinmaya Vishwa Vidyapeeth",
        "CVV Ernakulam PhD eligibility",
        "CVV PhD entrance test",
        "part-time PhD CVV Kerala",
        "Chinmaya Vishwa Vidyapeeth PhD admission",
      ]}
      faqs={faqs}
    />
    ...
    <div className="kerala-university-details-wrapper">
      <div className="kerala-content-layout">
        ...
        <div className="kerala-side-box kerala-left-box">
          ...
          <ul>
            <li>
              <b>Year of Establishment:</b> 2016
            </li>
            <li>
            ...
            <li>
              ...
              <br /> 30–50 scholars per year
            </li>
            <li>
              <b>Why Choose CVV:</b>
              <br /> Focus on Sanskrit, Spirituality, Social Sciences with
              holistic education and research ethos.
            </li>
          </ul>
        </div>
