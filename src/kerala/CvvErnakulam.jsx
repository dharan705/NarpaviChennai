...
const faqs = [
  {
    ...
    answer:
      "CVV typically opens admissions once a year around June–July. Notifications are posted on the official CVV admissions portal.",
  },
  {
    question: "What is the eligibility criteria?",
    answer:
      "A Master’s degree with minimum 55% marks (50% for reserved categories). UGC-NET/JRF/GATE-qualified candidates may get exemptions from the entrance exam.",
  },
  {
    question: "Is there an entrance test plus interview?",
    answer:
      "Yes, CVV conducts an internal written test followed by an interview for non-NET/GATE candidates.",
  },
  {
    question: "Are part-time PhDs allowed?",
    answer:
      "Yes. Working professionals with at least 2 years’ experience and an employer's NOC may apply.",
  },
  {
    question: "Does CVV offer research fellowships?",
    answer:
      "Yes—UGC-JRF, internal assistantships, and university scholarships are available based on merit.",
  },
];
...
const universityData = {
  ...
  applicationTimeline:
    "June–July annually (check official CVV portal)",
  approxFee: "₹20,000 – ₹45,000 per year",
  scholarshipAvailability:
    "UGC-JRF, internal assistantships, university scholarships",
};
...
const CvvErnakulam = () => (
  <div className="kerala-main">
    <SEO
      ...
      description="PhD admission guidance for Chinmaya Vishwa Vidyapeeth (CVV), Ernakulam – eligibility, CVV written / UGC-NET/GATE exemptions, full-time and part-time options, fees, documents, and fellowships."
      url="/kerala/phd-admission-at-chinmaya-vishwa-vidyapeet"
      keywords={[
        "PhD admission CVV Ernakulam",
        "Chinmaya Vishwa Vidyapeeth PhD eligibility",
        "CVV PhD entrance test",
        "part-time PhD CVV Ernakulam",
        "Chinmaya Vishwa Vidyapeeth Ernakulam PhD admission",
      ]}
      faqs={faqs}
    />
      ...
      <div className="kerala-content-layout">
        ...
        <div className="kerala-side-box kerala-left-box">
          ...
          <ul>
            ...
            <li>
              <b>Why Choose CVV:</b>
              <br /> Focus on Sanskrit, Indic studies and interdisciplinary
              research with cultural emphasis.
            </li>
          </ul>
        </div>
