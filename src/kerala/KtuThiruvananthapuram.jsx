...
const faqs = [
  {
    ...
    answer:
      "KTU generally opens PhD admissions once every academic year. Notifications are usually released in July–August. Check the official KTU website for dates.",
  },
  {
    question: "What is the eligibility criteria?",
    answer:
      "A Master’s degree in relevant field with at least 60% marks (55% for reserved categories). NET/JRF/GATE certificates are accepted.",
  },
  {
    question: "Is an entrance exam required?",
    answer:
      "Yes, KTU conducts its own PhD entrance test followed by a personal interview. Candidates with NET/GATE/JRF may be exempted from the written exam.",
  },
  {
    question:
      "Can working professionals apply for part‑time PhD at KTU?",
    answer:
      "Yes. Part‑time PhD is allowed for employed candidates with a No Objection Certificate and relevant work experience.",
  },
  {
    question: "Are fellowships available?",
    answer:
      "Yes. UGC‑JRF, KSCSTE fellowships and institutional assistantships are available based on performance and funding.",
  },
];

const universityData = {
  fullName:
    "PhD Admission at APJ Abdul Kalam Technological University, Thiruvananthapuram",
  shortName: "KTU",
  phdEntranceExam: "KTU Entrance Test / NET / GATE / JRF",
  qualificationRequired:
    "Master’s degree with ≥60% marks (55% for reserved category)",
  ...
  applicationTimeline:
    "July–August each year (check official notification)",
  approxFee: "₹20,000 – ₹40,000 per year",
  scholarshipAvailability:
    "UGC-JRF, KSCSTE and institutional fellowships",
};

const KtuThiruvananthapuram = () => (
  <div className="kerala-main">
    <SEO
      title="PhD Admission at APJ Abdul Kalam Technological University, Thiruvananthapuram"
      description="PhD admission guidance for APJ Abdul Kalam Technological University (KTU) – eligibility, KTU entrance/NET/GATE/JRF, full-time and part-time PhDs, timelines, fees, and fellowship options."
      url="/kerala/phd-admission-at-apj-abdul-kalam-technological-university"
      keywords={[
        "PhD admission KTU",
        "APJ Abdul Kalam Technological University PhD eligibility",
        "KTU PhD entrance test",
        "part-time PhD KTU",
        "KTU PhD fellowships",
      ]}
      faqs={faqs}
    ...
    <div className="kerala-university-details-wrapper">
      <div className="kerala-content-layout">
        ...
        <div className="kerala-side-box kerala-left-box">
          ...
          <ul>
            <li>
              <b>Year of Establishment:</b> 2014
            </li>
            <li>
            ...
            <li>
              ...
              <br /> 150+ scholars enrolled annually
            </li>
            <li>
              <b>Why Choose KTU:</b>
              <br /> State technical university with robust engineering research,
              good labs, and industry linkages.
            </li>
          </ul>
        </div>
