...
const faqs = [
  {
    ...
    answer:
      "Yes, JNTUA Anantapur regularly invites applications for PhD admission in Engineering, Science, Management, and other fields based on availability.",
  },
  {
    question: "What is the selection process for PhD at JNTUA?",
    answer:
      "Candidates must appear for the JNTUA PhD Entrance Exam followed by an interview. Exemptions are given to GATE/NET qualified candidates.",
  },
  {
    question:
      "Can working professionals apply for a PhD at JNTUA?",
    answer:
      "Yes, part-time PhD programs are available for faculty and industry professionals with relevant experience and employer NOC.",
  },
  {
    question: "Does JNTUA provide any scholarships?",
    answer:
      "Yes, eligible full-time scholars can avail UGC/CSIR fellowships or project assistantships based on department availability.",
  },
  {
    question: "What is the minimum qualification required?",
    answer:
      "A Master’s degree in the relevant field with at least 55% marks is required (50% for SC/ST/OBC).",
  },
];

const universityData = {
  fullName:
    "PhD Admission in JNTUA Anantapur – Jawaharlal Nehru Technological University",
  shortName: "JNTUA",
  ...
  scholarshipAvailability:
    "Yes, for full-time scholars through various schemes",
};
...
const JNTUAAnantapur = () => {
  return (
    <div className="andhra-main">
      <SEO
        title="PhD Admission in JNTUA Anantapur"
        description="PhD admission guidance for JNTUA Anantapur, including eligibility, JNTUA PhD entrance test, part-time options for working professionals, fees, documents, and scholarship schemes."
        url="/andhra/phd-admission-in-jntua-anantapur"
        keywords={[
          "PhD admission in JNTUA Anantapur",
          "JNTUA PhD eligibility",
          "JNTUA PhD entrance exam",
          "part-time PhD JNTUA",
          "JNTUA Anantapur PhD admission",
        ]}
        faqs={faqs}
      />
      ...
      <div className="andhra-university-details-wrapper">
        <div className="andhra-content-layout">
          ...
          <div className="andhra-side-box andhra-left-box">
            ...
            <ul>
              <li>
                <b>Established:</b> 1946 (Engineering College), became JNTUA in
                2008
              </li>
              <li>
                <b>Type:</b> State Technical University
              </li>
              <li>
              ...
              <li>
                <b>PhD Disciplines:</b> Engineering, Science, Pharmacy,
                Management
              </li>
            </ul>
          </div>
