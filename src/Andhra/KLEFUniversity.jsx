...
const faqs = [
  {
    ...
    answer:
      "Yes, KLEF invites applications for PhD programs in Engineering, Management, and other fields, typically twice a year.",
  },
  {
    question: "What is the selection process for PhD at KLEF?",
    answer:
      "Candidates must clear the KLEF PhD Entrance Test (KLURAT) followed by an interview. GATE/NET/JRF/MPhil qualified candidates are exempt from the entrance test.",
  },
  {
    question: "Can working professionals apply for a PhD at KLEF?",
    answer:
      "Yes, part-time PhD programs are available for working professionals with a minimum of 2 years of relevant experience and an employer’s NOC.",
  },
  {
    question: "Does KLEF provide any scholarships for PhD scholars?",
    answer:
      "Yes, full-time PhD scholars may receive fellowships or stipends based on eligibility and availability, such as UGC/CSIR or university-specific schemes.",
  },
  {
    question:
      "What is the minimum qualification required for PhD at KLEF?",
    answer:
      "A Master’s degree in the relevant field with at least 55% marks (50% for SC/ST/OBC candidates) is required.",
  },
];

const universityData = {
  fullName:
    "PhD Admission in Koneru Lakshmaiah Education Foundation (KLEF) – KL University",
  shortName: "KLEF (KL University)",
  phdEntranceExam: "KLURAT / GATE / NET / JRF / MPhil + Interview",
  qualificationRequired:
    "Master’s degree with minimum 55% in relevant discipline (50% for SC/ST/OBC)",
  ...
  scholarshipAvailability:
    "Yes, for full-time scholars through UGC/CSIR or university schemes",
};
...
const KLEFPhDAdmission = () => {
  return (
    <div className="andhra-main">
      <SEO
        title="PhD Admission in KLEF – KL University"
        description="PhD admission guidance for Koneru Lakshmaiah Education Foundation (KLEF) – KL University, including eligibility, KLURAT entrance, part-time options, fees, documents, and scholarship details."
        url="/andhra/phd-admission-in-klef"
        keywords={[
          "PhD admission in KLEF",
          "KL University PhD eligibility",
          "KLURAT PhD entrance test",
          "part-time PhD KLEF",
          "KLEF KL University PhD admission",
        ]}
        faqs={faqs}
      />
      ...
      <div className="andhra-university-details-wrapper">
        <div className="andhra-content-layout">
          ...
          <div className="andhra-side-box andhra-left-box">
            ...
            <ul>
              <li>
                <b>Established:</b> 1980, deemed university in 2009
              </li>
              <li>
                <b>Type:</b> Deemed-to-be University
              </li>
              <li>
                <b>Location:</b> Vaddeswaram, Guntur, Andhra Pradesh
              </li>
              <li>
                <b>NAAC Accreditation:</b> A++ Grade
              </li>
              <li>
                <b>Recognized By:</b> UGC, AICTE
              </li>
              <li>
                <b>PhD Disciplines:</b> Engineering, Management, Sciences,
                Humanities
              </li>
            </ul>
          </div>
          ...
          <div className="andhra-university-details-container">
            <img
              src="/images/klef-campus.jpg"
              alt="KLEF Campus"
              className="andhra-phdimg"
            />
          ...
          <div className="andhra-side-box andhra-right-box">
            ...
            <ul>
              ...
              <li>
                <a href="/andhra/phd-admission-in-klef">
                  KLEF (KL University)
                </a>
              </li>
              <li>
