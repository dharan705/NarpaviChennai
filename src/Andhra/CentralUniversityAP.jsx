...
const faqs = [
  {
    question:
      "Is PhD admission open at the Central University of Andhra Pradesh?",
    answer:
      "Yes, the university periodically announces PhD admissions in Engineering and other disciplines as per UGC guidelines.",
  },
  {
    question: "What is the selection process for PhD at CUAP?",
    answer:
      "Selection is based on CUET-PG/UGC-NET scores followed by a personal interview conducted by the respective department.",
  },
  {
    question: "Are part-time PhD options available at CUAP?",
    answer:
      "Currently, CUAP offers full-time PhD programs. Part-time modes may be introduced in the future.",
  },
  {
    question: "Does CUAP offer any fellowships?",
    answer:
      "Yes, UGC fellowships such as JRF and institutional assistantships are available for eligible full-time scholars.",
  },
  {
    question: "What is the eligibility requirement?",
    answer:
      "A Master's degree in Engineering/Technology with at least 55% marks (50% for SC/ST/OBC) is required.",
  },
];
...
const universityData = {
  ...
  qualificationRequired:
    "Master’s degree in Engineering/Technology with minimum 55%",
  ...
  scholarshipAvailability:
    "Yes, through UGC fellowships and institutional support",
};
...
const CentralUniversityAP = () => {
  return (
    <div className="andhra-main">
      <SEO
        title="PhD Admission in Central University of Andhra Pradesh – CUAP"
        description="PhD admission guidance for Central University of Andhra Pradesh (CUAP), including eligibility, CUET-PG / UGC-NET based selection, fees, documents, and fellowship options."
        url="/andhra/phd-admission-in-central-university-of-andhra-pradesh"
        keywords={[
          "PhD admission in Central University of Andhra Pradesh",
          "CUAP PhD eligibility",
          "CUAP PhD entrance exam",
          "PhD admission Anantapur central university",
          "CUET-PG PhD admission CUAP",
        ]}
        faqs={faqs}
      />
        ...
        <div className="andhra-content-layout">
          ...
          <div className="andhra-side-box andhra-left-box">
            ...
            <ul>
              ...
              <li>
                <b>NAAC Accreditation:</b> Awaiting first cycle
              </li>
              <li>
                <b>Recognized By:</b> UGC
              </li>
              <li>
                <b>PhD Disciplines:</b> Engineering, Science, Social Sciences,
                Languages
              </li>
            </ul>
          </div>
