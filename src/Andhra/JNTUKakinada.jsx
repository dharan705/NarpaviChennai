...
const faqs = [
  {
    ...
    answer:
      "Yes, JNTU Kakinada offers PhD programs in various disciplines such as Engineering, Science, Management, and Humanities.",
  },
  {
    question: "What is the eligibility for PhD at JNTU Kakinada?",
    answer:
      "A Master's degree in a relevant discipline with at least 55% marks is required. SC/ST candidates may have a relaxation of 5%.",
  },
  {
    question: "Is an entrance exam mandatory for PhD admission?",
    answer:
      "Yes, candidates must clear the JNTUK PhD Entrance Test and Interview. Exemption is available for NET/SET/GATE qualified candidates.",
  },
  {
    question: "Are part-time PhD options available?",
    answer:
      "Yes, JNTUK provides part-time PhD opportunities for working professionals with relevant experience and NOC from employer.",
  },
  {
    question: "Are scholarships or fellowships available?",
    answer:
      "Yes, fellowships such as UGC JRF, CSIR, and other project-based funding may be available based on department and merit.",
  },
];

const universityData = {
  fullName:
    "PhD Admission in JNTU Kakinada – Jawaharlal Nehru Technological University",
  shortName: "JNTUK",
  phdEntranceExam:
    "JNTUK PhD Entrance Test / GATE / NET / SET + Interview",
  qualificationRequired:
    "Master’s degree in Engineering/Technology/Science with minimum 55%",
...
const JNTUKakinada = () => {
  return (
    <div className="andhra-main">
      <SEO
        title="PhD Admission in JNTU Kakinada – JNTUK"
        description="PhD admission guidance for JNTU Kakinada, including eligibility, JNTUK PhD entrance test, part-time options for working professionals, fees, documents, and scholarship/fellowship details."
        url="/andhra/phd-admission-in-jntuk-kakinada"
        keywords={[
          "PhD admission in JNTU Kakinada",
          "JNTUK PhD eligibility",
          "JNTUK PhD entrance test",
          "part-time PhD JNTU Kakinada",
          "JNTU Kakinada PhD admission",
        ]}
        faqs={faqs}
      />
      ...
      <div className="andhra-university-details-wrapper">
        <div className="andhra-content-layout">
          ...
          <div className="andhra-side-box andhra-left-box">
            ...
            <ul>
              <li>
                <b>Established:</b> 1946 (as Engineering College), became JNTU in
                1972
              </li>
              <li>
                <b>Type:</b> State Public Technical University
              </li>
              <li>
                <b>Location:</b> Kakinada, Andhra Pradesh
              </li>
              <li>
              ...
              <li>
                <b>PhD Streams:</b> Engineering, Science, Pharmacy, Management,
                Humanities
              </li>
            </ul>
          </div>
          ...
          <div className="andhra-side-box andhra-right-box">
            ...
            <ul>
              ...
              <li>
                <a href="/andhra/phd-admission-in-sri-venkateswara-university">
              ...
              <li>
                <a href="/andhra/phd-admission-in-dravidian-university">
