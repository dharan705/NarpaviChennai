...
const faqs = [
  {
    question:
      "Does Central Tribal University of Andhra Pradesh offer PhD programs?",
    answer:
      "Yes, the university offers PhD programs in Arts, Languages, and Social Sciences. New disciplines may be added based on faculty availability.",
  },
  {
    question: "What is the PhD admission process at CTUAP?",
    answer:
      "Admission is based on a university-conducted entrance test or UGC-NET/CUET scores, followed by an interview.",
  },
  {
    question: "Are there any fellowships available for PhD scholars?",
    answer:
      "Yes, eligible full-time research scholars can apply for UGC JRF and other central government fellowships.",
  },
  {
    question: "Can I apply for a PhD without NET?",
    answer:
      "Yes, candidates can appear for the university’s entrance exam if they do not have a UGC-NET/CUET score.",
  },
  {
    question: "Is there any reservation for tribal candidates?",
    answer:
      "Yes, reservations are provided as per Government of India norms, including special focus on tribal students.",
  },
];

const universityData = {
  fullName:
    "PhD Admission in Central Tribal University of Andhra Pradesh – Vizianagaram",
  shortName: "CTUAP",
  phdEntranceExam: "University Entrance Exam / CUET / UGC-NET + Interview",
  qualificationRequired:
    "Master’s degree in relevant Arts/Science stream with at least 55% (50% for SC/ST/OBC)",
  ...
  applicationTimeline:
    "Generally announced between May–June or November–December",
  approxFee: "₹10,000 – ₹18,000 per year",
  scholarshipAvailability:
    "Yes, UGC fellowships and tribal student schemes available",
};
...
const CentralTribalUniversityAP = () => {
  return (
    <div className="andhra-main">
      <SEO
        title="PhD Admission in Central Tribal University of Andhra Pradesh"
        description="Complete PhD admission guidance for Central Tribal University of Andhra Pradesh, Vizianagaram, including eligibility, entrance exam, reservations for tribal students, fees, and fellowships."
        url="/andhra/phd-admission-in-central-tribal-university-of-andhra-pradesh"
        keywords={[
          "PhD admission in Central Tribal University of Andhra Pradesh",
          "CTUAP PhD eligibility",
          "CTUAP PhD entrance exam",
          "PhD admission Vizianagaram",
          "tribal university PhD admission",
        ]}
        faqs={faqs}
      />
        ...
        <div className="andhra-content-layout">
          ...
          <div className="andhra-side-box andhra-left-box">
            ...
            <ul>
              ...
              <li>
                <b>Location:</b> Vizianagaram, Andhra Pradesh
              </li>
              <li>
                <b>NAAC Accreditation:</b> To be accredited
              </li>
              <li>
                <b>Recognized By:</b> UGC
              </li>
              <li>
                <b>PhD Disciplines:</b> Arts, Languages, Social Sciences,
                Tribal Studies
              </li>
            </ul>
          </div>
          ...
          <div className="andhra-side-box andhra-right-box">
            ...
            <ul>
              ...
              <li>
                Support for socially and economically disadvantaged communities
              </li>
