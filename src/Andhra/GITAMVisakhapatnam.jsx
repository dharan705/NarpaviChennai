...
const faqs = [
  {
    question:
      "What is the eligibility for PhD admission at GITAM Visakhapatnam?",
    answer:
      "Candidates must have a Master’s degree (M.Tech, M.E, MBA, M.Sc, etc.) with at least 55% marks or equivalent CGPA from a recognized institution.",
  },
  {
    question: "Does GITAM conduct a separate entrance exam for PhD?",
    answer:
      "Yes, GITAM conducts its own PhD entrance exam and interview. UGC-NET/GATE qualified candidates may be exempted.",
  },
  {
    question:
      "What research areas are available at GITAM Visakhapatnam?",
    answer:
      "PhD research is available in Engineering (CSE, ECE, Mechanical, Civil), Management, Sciences, Pharmacy, and Humanities.",
  },
  {
    question:
      "Is fellowship or stipend available for PhD scholars?",
    answer:
      "Yes, GITAM provides fellowships to full-time PhD scholars based on merit and availability of funded projects.",
  },
  {
    question:
      "When does the PhD admission process usually start at GITAM?",
    answer:
      "PhD admission notifications are generally released in May/June and the selection process completes by August/September.",
  },
];
...
const GITAMVisakhapatnam = () => {
  return (
    <div className="telangana-main">
      <SEO
        title="PhD Admission in GITAM Visakhapatnam Campus"
        description="PhD admission guidance for GITAM University Visakhapatnam, including eligibility, entrance exam details, research areas, fee structure, and fellowships for full-time scholars."
        url="/telangana/phd-admission-in-gitam-visakhapatnam"
        keywords={[
          "PhD admission in GITAM Visakhapatnam",
          "GITAM University Visakhapatnam PhD eligibility",
          "GITAM PhD entrance exam",
          "PhD admission Visakhapatnam GITAM",
      ...
      <div className="telangana-university-details-wrapper">
        <div className="telangana-content-layout">
          ...
          <div className="telangana-side-box telangana-left-box">
            ...
            <ul>
              <li>
                <b>Established:</b> 1980
              </li>
              <li>
                <b>Type:</b> Deemed to be University
              </li>
              <li>
                <b>Location:</b> Visakhapatnam, Andhra Pradesh
              </li>
              <li>
                <b>Recognized By:</b> UGC, AICTE, NAAC A++
              </li>
              <li>
                <b>Faculties:</b> Engineering, Management, Science, Pharmacy,
                Law, Humanities
              </li>
              <li>
                <b>Research Areas:</b>
                <br />
                CSE, ECE, Mechanical, Civil, Business Management, Physics,
                Chemistry, Pharmacy, Law
              </li>
            </ul>
          </div>
