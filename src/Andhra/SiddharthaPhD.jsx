...
const faqs = [
  {
    ...
    answer:
      "Yes, SAHE (formerly VRSEC) offers PhD programs in disciplines such as CSE, ECE, EEE, Civil, Mechanical, IT, and AI/ML.",
  },
  {
    question: "What is the eligibility for PhD at SAHE?",
    answer:
      "Candidates must have a Master's degree in relevant discipline with minimum 55% marks (5% relaxation for reserved categories).",
  },
  {
    question: "Is there an entrance test for PhD admission?",
    answer:
      "Yes, SAHE conducts a written test and interview. GATE/NET qualified candidates may be exempted from the written test.",
  },
  {
    question: "Is work experience necessary for part-time PhD?",
    answer:
      "Yes, for part-time mode, applicants should be employed in teaching, research, or industry with a minimum of 2 years of experience.",
  },
  {
    question: "Does SAHE provide any financial assistance for PhD?",
    answer:
      "Yes, eligible full-time PhD scholars in Engineering can receive ₹25,000/month stipend under HTRA, along with fee waivers in some cases.",
  },
];

const universityData = {
  fullName:
    "PhD Admission at Siddhartha Academy of Higher Education (SAHE), Vijayawada",
  shortName: "SAHE",
  phdEntranceExam:
    "SAHE Written Test + Interview (GATE/NET qualified candidates may get exemption)",
  qualificationRequired:
    "Master’s degree with minimum 55%; 5% relaxation for reserved categories",
  workExperience:
    "Required for part-time mode (minimum 2 years in teaching/research/industry)",
  ...
  scholarshipAvailability:
    "Stipend of ₹25,000/month for eligible full-time scholars; teaching assistant roles available",
};
...
const SiddharthaPhD = () => {
  return (
    <div className="andhra-main">
      <SEO
        title="PhD Admission at Siddhartha Academy of Higher Education (SAHE), Vijayawada"
        description="PhD admission guidance for SAHE (VRSEC), including eligibility, SAHE written test and GATE/NET exemptions, part-time options, fees, documents, and stipend/HTRA details."
        url="/andhra/phd-admission-in-siddhartha-academy-vijayawada"
        keywords={[
          "PhD admission at SAHE",
          "Siddhartha Academy PhD eligibility",
          "VRSEC SAHE PhD entrance test",
          "part-time PhD SAHE Vijayawada",
          "SAHE PhD admission",
        ]}
        faqs={faqs}
      />
      ...
      <div className="andhra-university-details-wrapper">
        <div className="andhra-content-layout">
          ...
          <div className="andhra-side-box andhra-left-box">
            ...
            <ul>
              <li>
                <b>Established:</b> 1977 (as VRSEC); Deemed-to-be University
                since 2024
              </li>
              <li>
              ...
              <li>
                <b>Location:</b> Kanuru, Vijayawada, Andhra Pradesh
              </li>
              <li>
                <b>Recognized By:</b> UGC, AICTE, NAAC “A+” Grade
              </li>
              <li>
                <b>PhD Disciplines:</b> CSE, ECE, EEE, Civil, Mechanical, IT,
                AI/ML, Sciences, Management
              </li>
            </ul>
          </div>
