...
const faqs = [
  {
    question:
      "What is the eligibility for PhD admission at Adikavi Nannaya University?",
    answer:
      "Candidates must have a postgraduate degree (M.Tech/M.E/M.Sc/MBA/M.Com) with at least 55% marks or equivalent CGPA.",
  },
  {
    question:
      "Does Adikavi Nannaya University conduct its own PhD entrance exam?",
    answer:
      "Yes, the university conducts its own PhD entrance test. UGC-NET/GATE qualified candidates may be exempted.",
  },
  {
    question: "What are the research areas available for PhD?",
    answer:
      "PhD is offered in disciplines like Computer Science, Electronics, Mechanical, Civil Engineering, and Business Management.",
  },
  {
    question: "Is work experience required for applying?",
    answer:
      "No, prior work experience is not mandatory for admission into the PhD program.",
  },
  {
    question: "When does the PhD admission process start?",
    answer:
      "Generally, PhD admissions start in June or July and conclude by September.",
  },
];
...
const AdikaviNannaya = () => {
  return (
    <div className="telangana-main">
      <SEO
        title="PhD Admission in Adikavi Nannaya University"
        description="Complete PhD admission guidance for Adikavi Nannaya University, including eligibility, entrance exam details, fee structure, part-time options, and available research areas."
        url="/andhra/phd-admission-in-adikavi-nannaya-university"
        keywords={[
          "PhD Admission in Adikavi Nannaya University",
          "Adikavi Nannaya University PhD eligibility",
          "Adikavi Nannaya University PhD entrance exam",
          "PhD admission Rajamahendravaram",
          "AKNU PhD admission",
        ]}
        faqs={faqs}
      />
        ...
        <div className="telangana-content-layout">
          ...
          <div className="telangana-side-box telangana-left-box">
            ...
            <ul>
              ...
              <li>
                <b>Location:</b> Rajamahendravaram, Andhra Pradesh
              </li>
              <li>
                <b>Recognized By:</b> UGC
              </li>
              <li>
                <b>Faculties:</b> Engineering, Management, Science, Arts
              </li>
              <li>
                <b>Research Areas:</b>
                <br />
                CSE, ECE, Mechanical, Civil, Business Management, Tourism
              </li>
            </ul>
          </div>
