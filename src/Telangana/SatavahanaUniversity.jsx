...
const faqs = [
  {
    ...
    answer:
      "Candidates must hold a Master's degree with at least 55% marks (50% for reserved categories) in relevant disciplines.",
  },
  {
    question: "Does Satavahana University conduct a PhD entrance exam?",
    answer:
      "Yes, the university conducts an entrance exam. UGC-NET/CSIR-NET qualified candidates may be exempted.",
  },
  {
    question: "What disciplines are offered for PhD at Satavahana University?",
    answer:
      "PhD programs are offered in disciplines such as Chemistry, English, Commerce, Economics, Sociology, and others.",
  },
  {
    question: "Are fellowships available at Satavahana University?",
    answer:
      "Fellowships may be available for full-time research scholars based on merit and funding.",
  },
  {
    question: "When does the application process start?",
    answer:
      "Typically, the application process starts between May and July each year.",
  },
];
...
const SatavahanaUniversity = () => {
  return (
    <div className="telangana-main">
      <SEO
        title="PhD Admission in Satavahana University"
        description="PhD admission guidance for Satavahana University – eligibility, university PhD entrance/UGC-NET, full-time and part-time options, timelines, fee range, documents, and fellowship availability."
        url="/telangana/phd-admission-in-satavahana-university"
        keywords={[
          "PhD admission Satavahana University",
          "Satavahana University PhD eligibility",
          "Satavahana University PhD entrance test",
          "part-time PhD Satavahana University",
          "Satavahana University PhD fellowship",
        ]}
        faqs={faqs}
      />
        ...
        <div className="telangana-content-layout">
          ...
          <div className="telangana-side-box telangana-left-box">
            ...
            <ul>
              ...
              <li>
                <b>Location:</b> Karimnagar, Telangana
              </li>
              <li>
                <b>Recognized By:</b> UGC
              </li>
              <li>
                <b>Faculties:</b> Science, Commerce, Arts, Social Sciences
              </li>
              <li>
                <b>Research Areas:</b>
                <br />
                Chemistry, English, Management, Commerce, Sociology
              </li>
            </ul>
          </div>
