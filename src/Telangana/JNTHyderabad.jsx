...
const faqs = [
  {
    ...
    answer:
      "PhD admissions at JNTU Hyderabad are generally announced between May and July each year.",
  },
  {
    question: "What is the eligibility for PhD admission at JNTUH?",
    answer:
      "A Master’s degree in Engineering/Technology/Management/Pharmacy/Science with at least 55% marks (50% for reserved categories).",
  },
  {
    question: "Is an entrance test required for PhD at JNTU Hyderabad?",
    answer:
      "Yes, the university conducts a written test and interview. Candidates with valid UGC-NET/JRF/GATE may be exempted.",
  },
  {
    question: "Is part-time PhD allowed at JNTUH?",
    answer:
      "Yes, part-time PhD is available for working professionals with NOC and required experience.",
  },
  {
    question: "Are fellowships available for PhD at JNTU Hyderabad?",
    answer:
      "Limited university fellowships and external funding options are available for eligible candidates.",
  },
];

const universityData = {
  fullName:
    "PhD Admission in Jawaharlal Nehru Technological University, Hyderabad (JNTUH)",
...
const JNTHyderabad = () => {
  return (
    <div className="telangana-main">
      <SEO
        title="PhD Admission in Jawaharlal Nehru Technological University, Hyderabad (JNTUH)"
        description="PhD admission guidance for JNTU Hyderabad – eligibility, university written test/UGC-NET/JRF/GATE, full-time and part-time options, timelines, fees, documents, and fellowship details."
        url="/telangana/phd-admission-in-jawaharlal-nehru-technological-university"
        keywords={[
          "PhD admission JNTU Hyderabad",
          "JNTUH PhD eligibility",
          "JNTU Hyderabad PhD entrance test",
          "part-time PhD JNTUH",
          "JNTUH PhD fellowships",
        ]}
        faqs={faqs}
      />
      ...
      <div className="telangana-university-details-wrapper">
        <div className="telangana-content-layout">
          ...
          <div className="telangana-side-box telangana-left-box">
            ...
            <ul>
              <li>
                <b>Established:</b> 1972
              </li>
              <li>
                <b>Type:</b> State Technical University
              </li>
              <li>
                <b>Accreditation:</b> NAAC ‘A’ Grade
              </li>
              <li>
                <b>Specialization:</b>
                <br /> Engineering, Technology, Management, and Pharmacy
              </li>
              <li>
                <b>Research Strength:</b>
                <br /> Strong R&D infrastructure, research centers, and tech
                innovation focus
              </li>
            </ul>
          </div>
