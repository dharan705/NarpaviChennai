...
const faqs = [
  {
    question:
      "Does Aurora Higher Education & Research Academy offer PhD programs?",
    answer:
      "Yes, Aurora HER Academy offers PhD programs in Engineering and Computer Applications with a research-focused curriculum.",
  },
  {
    question:
      "What is the eligibility for PhD admission at Aurora HER Academy?",
    answer:
      "A Master’s degree in the relevant field (e.g. M.Tech, M.E., MCA, M.Sc.) with a minimum of 55% aggregate marks is required.",
  },
  {
    question:
      "Is there an entrance exam for PhD at Aurora HER Academy?",
    answer:
      "Yes, candidates must qualify the entrance test conducted by the university followed by a personal interview.",
  },
  {
    question: "Are part-time PhD options available?",
    answer:
      "Yes, part-time PhD options are available for working professionals who meet the necessary eligibility criteria.",
  },
  {
    question:
      "Does Aurora offer any scholarships for PhD scholars?",
    answer:
      "Limited financial support or stipends may be offered based on merit and department policies.",
  },
];

const universityData = {
  fullName:
    "PhD Admission in Aurora Higher Education & Research Academy, Hyderabad",
  shortName: "Aurora HER Academy",
  phdEntranceExam: "University Written Test + Interview",
  qualificationRequired:
    "Master’s in Engineering/Computer Applications with 55%",
...
const AuroraHERAHyderabad = () => {
  return (
    <div className="telangana-main">
      <SEO
        title="PhD Admission in Aurora Higher Education & Research Academy, Hyderabad"
        description="PhD admission guidance for Aurora HER Academy – eligibility, university written test and interview, full-time and part-time modes, timelines, fees, documents, and scholarship options."
        url="/telangana/phd-admission-in-aurora-higher-education-and-research-academy"
        keywords={[
          "PhD admission Aurora HER Academy",
          "Aurora Higher Education and Research Academy PhD eligibility",
          "Aurora HER Academy PhD entrance test",
          "part-time PhD Aurora Hyderabad",
          "Aurora HER Academy PhD scholarships",
        ]}
        faqs={faqs}
      />
      ...
      <div className="telangana-university-details-wrapper">
        <div className="telangana-content-layout">
          ...
          <div className="telangana-side-box telangana-left-box">
            ...
            <ul>
              <li>
                <b>Established:</b> 2000
              </li>
              <li>
                <b>Type:</b> Private Research Institution
              </li>
              <li>
                <b>Location:</b> Hyderabad, Telangana
              </li>
              <li>
                <b>Approved By:</b> AICTE, UGC
              </li>
              <li>
                <b>Research Areas:</b>
                <br />
                Computer Science, Electronics, Information Technology, AI,
          ...
          <div className="telangana-side-box telangana-right-box">
            ...
            <ul>
              ...
              <li>
                <a href="/telangana/phd-admission-in-aurora-hyderabad">
                  Aurora HER Academy
                </a>
              </li>
              <li>
