...
const faqs = [
  {
    ...
    answer:
      "Yes, Woxsen University offers PhD programs in Management, Engineering, and related interdisciplinary areas.",
  },
  {
    question: "What is the eligibility for PhD admission at Woxsen University?",
    answer:
      "Candidates must have a Master’s degree (MBA, M.Tech, M.E. or equivalent) with at least 55% marks or equivalent CGPA.",
  },
  {
    question: "Is there an entrance exam for PhD at Woxsen University?",
    answer:
      "Yes, applicants must qualify the university's entrance test followed by a personal interview.",
  },
  {
    question: "Are part-time PhD options available?",
    answer:
      "Yes, Woxsen offers both full-time and part-time PhD programs catering to working professionals.",
  },
  {
    question: "Does Woxsen provide research fellowships?",
    answer:
      "Yes, limited research fellowships are offered to meritorious full-time PhD scholars.",
  },
];
...
const universityData = {
  ...
  scholarshipAvailability:
    "Available for full-time PhD scholars based on merit",
};
...
const WoxsenUniversity = () => {
  return (
    <div className="telangana-main">
      <SEO
        title="PhD Admission in Woxsen University, Hyderabad"
        description="PhD admission guidance for Woxsen University – eligibility, university entrance test and interview, full-time and part-time options, timelines, fee range, documents required, and research fellowship availability."
        url="/telangana/phd-admission-in-woxsen-university"
        keywords={[
          "PhD admission Woxsen University",
          "Woxsen University PhD eligibility",
          "Woxsen University PhD entrance test",
          "part-time PhD Woxsen University",
          "Woxsen University PhD fellowship",
        ]}
        faqs={faqs}
      />
      ...
      <div className="telangana-university-details-wrapper">
        <div className="telangana-content-layout">
          ...
          <div className="telangana-side-box telangana-left-box">
            ...
            <ul>
              <li>
                <b>Established:</b> 2014 (Declared Private University in 2020)
              </li>
              <li>
              ...
              <li>
                <b>Research Areas:</b>
                <br />
                Management, Marketing, AI/ML, Data Science, Business Analytics,
