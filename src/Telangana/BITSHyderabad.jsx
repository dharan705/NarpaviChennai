...
const faqs = [
  {
    ...
    answer:
      "Yes, BITS Hyderabad offers full-time and part-time PhD programs in various disciplines of Engineering, Science, and interdisciplinary areas.",
  },
  {
    question: "What is the eligibility for PhD at BITS Hyderabad?",
    answer:
      "A Master’s degree (M.E./M.Tech./M.Sc./M.Phil) with minimum 60% aggregate or equivalent CGPA. Exceptional candidates with B.E./B.Tech may also apply.",
  },
  {
    question: "Is there an entrance exam for PhD admission at BITS Hyderabad?",
    answer:
      "Yes, BITS Pilani conducts a PhD entrance test and interview for eligible applicants. GATE/NET-qualified candidates may get exemptions.",
  },
  {
    question: "What is the mode of PhD offered by BITS Hyderabad?",
    answer:
      "Both full-time and part-time (for working professionals) PhD options are available.",
  },
  {
    question: "Are fellowships available for PhD students?",
    answer:
      "Yes, full-time PhD students may receive institute fellowships subject to academic performance and availability.",
  },
];

const universityData = {
  fullName:
    "PhD Admission in BITS Hyderabad - Birla Institute of Technology and Science",
  shortName: "BITS Hyderabad",
  phdEntranceExam: "BITS PhD Admission Test / NET / GATE",
  qualificationRequired:
    "M.E. / M.Tech / M.Sc. with 60% or CGPA 6.0+; Exceptional B.E./B.Tech candidates may apply",
  ...
  applicationTimeline:
    "PhD admissions usually open twice a year – June-July and Dec-Jan",
  approxFee: "₹50,000 – ₹1,00,000 per year (varies by department)",
  scholarshipAvailability:
    "Institute fellowship available for full-time PhD scholars",
};
...
const BITSHyderabad = () => {
  return (
    <div className="telangana-main">
      <SEO
        title="PhD Admission in BITS Hyderabad - Birla Institute of Technology and Science"
        description="PhD admission guidance for BITS Hyderabad – eligibility, BITS PhD admission test/NET/GATE, full-time and part-time options, timelines, fees, documents, and fellowship details."
        url="/telangana/phd-admission-in-birla-institute-of-technology-and-science"
        keywords={[
          "PhD admission BITS Hyderabad",
          "BITS Hyderabad PhD eligibility",
          "BITS Pilani PhD entrance test Hyderabad",
          "part-time PhD BITS Hyderabad",
          "BITS Hyderabad PhD fellowship",
        ]}
        faqs={faqs}
      />
        ...
        <div className="telangana-content-layout">
          ...
          <div className="telangana-side-box telangana-left-box">
            ...
            <ul>
              ...
              <li>
                <b>Type:</b> Deemed University
              </li>
              <li>
                <b>Location:</b> Hyderabad, Telangana
              </li>
              <li>
                <b>Parent Institute:</b> BITS Pilani
              </li>
              <li>
                <b>Approved By:</b> UGC
              </li>
          ...
          <div className="telangana-side-box telangana-right-box">
            ...
            <ul>
              ...
              <li>
                <a href="/telangana/phd-admission-in-rgukt-basar">
                  RGUKT Basar
                </a>
              </li>
              <li>
