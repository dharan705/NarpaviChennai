...
const faqs = [
  {
    ...
    answer:
      "Yes, RGUKT Basar offers PhD programs primarily in Engineering and interdisciplinary research areas.",
  },
  {
    question: "What are the eligibility criteria for PhD at RGUKT Basar?",
    answer:
      "A Master’s degree in the relevant field with at least 55% marks. Relaxation applies to reserved categories as per norms.",
  },
  {
    question: "Is there an entrance exam for PhD at RGUKT Basar?",
    answer:
      "Yes, candidates must qualify the university’s PhD entrance test or possess valid scores in UGC-NET/JRF/CSIR/GATE.",
  },
  {
    question: "Are part-time PhD programs offered at RGUKT Basar?",
    answer:
      "Yes, part-time PhD is available for working professionals meeting eligibility criteria.",
  },
  {
    question: "What is the research focus of RGUKT Basar?",
    answer:
      "RGUKT emphasizes Engineering, Technology, and interdisciplinary applied research areas.",
  },
];

const universityData = {
  fullName:
    "PhD Admission in Rajiv Gandhi University of Knowledge Technologies, Basar",
  shortName: "RGUKT Basar",
  phdEntranceExam: "RGUKT PhD Entrance Test / UGC-NET / CSIR / GATE",
  qualificationRequired:
    "Master’s degree in Engineering/Technology or related disciplines with 55% marks",
...
const RGUKTBasar = () => {
  return (
    <div className="telangana-main">
      <SEO
        title="PhD Admission in Rajiv Gandhi University of Knowledge Technologies, Basar"
        description="PhD admission guidance for RGUKT Basar – eligibility, RGUKT PhD entrance/UGC-NET/CSIR/GATE, full-time and part-time options, timelines, fee range, documents, and fellowship details."
        url="/telangana/phd-admission-in-rgukt-basar"
        keywords={[
          "PhD admission RGUKT Basar",
          "RGUKT Basar PhD eligibility",
          "RGUKT Basar PhD entrance test",
          "part-time PhD RGUKT Basar",
          "RGUKT Basar PhD fellowship",
        ]}
        faqs={faqs}
      />
        ...
        <div className="telangana-content-layout">
          ...
          <div className="telangana-side-box telangana-left-box">
            ...
            <ul>
              ...
              <li>
                <b>Location:</b> Basar, Telangana
              </li>
              <li>
                <b>Specialization:</b> Engineering and Technology
              </li>
              <li>
                <b>Approved By:</b> UGC
              </li>
