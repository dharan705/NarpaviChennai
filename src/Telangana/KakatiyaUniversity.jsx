...
const faqs = [
  {
    ...
    answer:
      "PhD admissions at Kakatiya University are typically announced once a year. Check the university's official website for current notifications.",
  },
  {
    question: "What is the eligibility for PhD at Kakatiya University?",
    answer:
      "Candidates must have a Master's degree in relevant disciplines with at least 55% marks. Relaxations apply for reserved categories.",
  },
  {
    question: "Is there an entrance exam for PhD at Kakatiya University?",
    answer:
      "Yes, the university conducts an entrance test followed by an interview. UGC-NET/JRF qualified candidates may be exempted from the written test.",
  },
  {
    question: "Are part-time PhD programs offered?",
    answer:
      "Yes, part-time PhD is available for working professionals with relevant experience and a No Objection Certificate (NOC) from their employer.",
  },
  {
    question: "Are fellowships available for PhD scholars?",
    answer:
      "Yes, eligible full-time PhD candidates may receive UGC fellowships or university financial assistance.",
  },
];
...
const KakatiyaUniversity = () => {
  return (
    <div className="telangana-main">
      <SEO
        title="PhD Admission in Kakatiya University, Warangal"
        description="PhD admission guidance for Kakatiya University – eligibility, entrance test/UGC-NET/JRF, full-time and part-time options, timelines, fees, required documents, and fellowships."
        url="/telangana/phd-admission-in-kakatiya-university-warangal"
        keywords={[
          "PhD admission Kakatiya University",
          "Kakatiya University PhD eligibility",
          "Kakatiya University PhD entrance exam",
          "part-time PhD Kakatiya University",
          "Kakatiya University PhD fellowship",
        ]}
        faqs={faqs}
      />
      ...
      <div className="telangana-university-details-wrapper">
        <div className="telangana-content-layout">
          ...
          <div className="telangana-side-box telangana-left-box">
            ...
            <ul>
              <li>
                <b>Year of Establishment:</b> 1976
              </li>
              <li>
              ...
              <li>
                ...
                <br /> Around 100+ across Arts, Science, Commerce, and Education
              </li>
              <li>
                <b>Why Choose Kakatiya:</b>
                <br /> Renowned for research in regional literature, social
                sciences, and fundamental sciences.
              </li>
            </ul>
          </div>
