...
const faqs = [
  {
    question:
      "What is the eligibility for PhD admission at Anurag University?",
    answer:
      "Candidates must have a Master’s degree (M.Tech/M.E/M.Sc) with a minimum of 55% marks or equivalent CGPA.",
  },
  {
    question: "Is there an entrance exam for PhD at Anurag University?",
    answer:
      "Yes, candidates need to qualify in Anurag University’s entrance exam or hold a valid UGC-NET/GATE score.",
  },
  {
    question: "What are the research domains at Anurag University?",
    answer:
      "Research is offered in Engineering fields such as Computer Science, ECE, Mechanical, Civil, and allied areas.",
  },
  {
    question: "Does Anurag University provide fellowships for PhD?",
    answer:
      "Yes, selected candidates may receive stipends/fellowships based on merit or funding projects.",
  },
  {
    question:
      "When does the PhD admission process at Anurag University start?",
    answer:
      "Typically, the process begins in May/June and continues till August.",
  },
];
...
const AnuragUniversity = () => {
  return (
    <div className="telangana-main">
      <SEO
        title="PhD Admission in Anurag University"
        description="PhD admission guidance for Anurag University, Hyderabad – eligibility, Anurag PhD entrance/UGC-NET/GATE options, full-time and part-time PhD, timelines, fees, documents, and fellowships."
        url="/telangana/phd-admission-in-anurag-university"
        keywords={[
          "PhD admission Anurag University",
          "Anurag University Hyderabad PhD eligibility",
          "Anurag University PhD entrance exam",
          "part-time PhD Anurag University",
          "Anurag University PhD fellowship",
        ]}
        faqs={faqs}
      />
      ...
      <div className="telangana-university-details-wrapper">
        <div className="telangana-content-layout">
          ...
          <div className="telangana-side-box telangana-left-box">
            ...
            <ul>
              <li>
                <b>Established:</b> 2020 (formerly Anurag Group of Institutions)
              </li>
              <li>
              ...
              <li>
                <b>Faculties:</b> Engineering, Pharmacy, Management
              </li>
              <li>
                <b>Research Areas:</b>
                <br />
