...
const faqs = [
  {
    ...
    answer:
      "Candidates must have a Master’s degree (M.A., M.Sc., M.Tech., M.E., etc.) with at least 55% marks. Relaxation is provided for reserved categories as per government norms.",
  },
  {
    question: "Is a PhD entrance exam required at Osmania University?",
    answer:
      "Yes, Osmania University conducts a PhD entrance exam. Candidates with UGC-NET/JRF/CSIR/GATE are exempted from the entrance.",
  },
  {
    question: "Which disciplines offer PhD at Osmania University?",
    answer:
      "PhD programs are available in Arts, Science, Engineering, Management, Commerce, and Social Sciences.",
  },
  {
    question: "Does Osmania University offer part-time PhD?",
    answer:
      "Yes, part-time and full-time options are available depending on department norms and candidate eligibility.",
  },
  {
    question: "What is the application period for PhD at Osmania University?",
    answer:
      "PhD admissions generally begin between May and July every year.",
  },
];
...
const OsmaniaUniversity = () => {
  return (
    <div className="telangana-main">
      <SEO
        title="PhD Admission in Osmania University, Hyderabad"
        description="PhD admission guidance for Osmania University – eligibility, OU PhD entrance/UGC-NET/CSIR/GATE, full-time and part-time options, timelines, fees, documents, and scholarship schemes."
        url="/telangana/phd-admission-in-osmania-university-hyderabad"
        keywords={[
          "PhD admission Osmania University",
          "Osmania University PhD eligibility",
          "Osmania University PhD entrance test",
          "part-time PhD Osmania University",
          "Osmania University PhD scholarship",
        ]}
        faqs={faqs}
      />
          ...
          <div className="telangana-side-box telangana-left-box">
            ...
            <ul>
              ...
              <li>
                <b>Research Areas:</b>
                <br />
                Arts, Science, Engineering, Law, Commerce, Social Sciences
              </li>
            </ul>
          </div>
