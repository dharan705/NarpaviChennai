...
const ConferenceWritingGuide = () => {
  return (
    <div className="phd-service">
      <SEO 
        title="Writing a Paper for Scopus-Indexed Journals | Complete Guide"
        description="Step-by-step guide to writing and publishing research papers in Scopus-indexed journals. Learn topic selection, methodology, formatting, and submission best practices."
...
/>
      <div className="conference-container">
        ...
        <section className="servicefaq-section">
          <h2>📘 FAQs on Scopus Journal Publications</h2>
